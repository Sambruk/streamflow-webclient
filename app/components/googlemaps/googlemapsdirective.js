...
angular.module('sf').directive('googleMap', function () {
    return {
        ...
        compile: function($scope, scope,$parent) {


            console.log('scope',$scope);
            console.log('scope2',scope);
            console.log('scope3', $parent);
        ...
        link: function ($scope, NgMap) {
            ...
            $scope.$watch('modelLoaded', function (newVal) {
                if (newVal) {
                    NgMap.getMap();/*.then(function (map) {
                        map.setZoom($scope.map.zo$om);
